...
description
   ...
   File:    Struck.osl
*/
 public  class Struck  extends psimjava.Process     {
static Scanner scan = new Scanner (System.in);
 ...
 private double  service_dur; 
  // 
 public Struck(  String  stname, double  unload_dur) { 
super(stname); 
truckNum =  Wareh.get_snumArr();
...
tracedisp(pname+ " acquired unloading bay");
 // display pname, " requesting 2 workers at ", simclock 
 // 
 // process will wait until 2 workers become available 
tracedisp(pname+ " requesting 2 workers at ");
 // 
 // 3 workers 
 Wareh.workers.acquire(2);
 // 
 simclock = StaticSync.get_clock();
