...
description
   ...
   File: SArrivals.osl
*/
 public  class SArrivals  extends psimjava.Process     {
static Scanner scan = new Scanner (System.in);
 ...
 // random number gen 
 public SArrivals(String  pname, double  mean_arr, double  low_serv, double  high_serv) { 
 // 
...
arrivalPeriod = new NegExp("Small truck Inter-arr", mean_arr);
 // using a uniform distribution 
servicePeriod = new Uniform("Small truck service", low_serv, high_serv);
aname =  pname;
...
Wareh.incr_smallTArr(); 
 // 
strname =  "Struck" + Wareh.get_snumArr();
 // create small truck object 
struckobj = new Struck(strname, serv_per);
 struckobj.start();
 // generate random inter-arr interval  
 inter_arr = arrivalPeriod.fdraw(); 
 simclk = StaticSync.get_clock();
